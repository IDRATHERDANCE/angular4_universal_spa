import { Component, OnInit, ViewContainerRef, ViewChild, ViewChildren, Renderer2, AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef } from '@angular/core';
...
export class ProjectComponent implements OnInit, AfterViewInit {
    ...
    @ViewChildren('textBox,mainImage', { read: ViewContainerRef })
